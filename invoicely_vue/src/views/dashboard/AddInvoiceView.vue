	...
	<div class="page-add-invoice">
		...
		<div class="columns is-multiline">
			...
			<div class="column is-12">
				...
				<div class="field">
					<label for="">Sender reference</label>
					<div class="control">
						<input
							type="text"
							class="input"
		...
		methods: {
			...
			updateTotals(changedItem) {
				...
				for (let i = 0; i < this.invoice.items.length; i++) {
					...
					vat_amount +=
						this.invoice.items[i].net_amount * (vat_rate / 100);
			...
			submitForm() {
				...
				this.invoice.client_contact_person =
					this.invoice.client.contact_person;
