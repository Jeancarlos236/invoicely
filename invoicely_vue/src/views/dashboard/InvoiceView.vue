	...
	<div class="page-invoice">
		...
		<div class="columns is-multiline">
			<div class="column is-12">
				...
				<div class="buttons">
					<button @click="getPdf()" class="button is-dark">
						Download PDF
					</button>

					<template
						v-if="!invoice.is_credit_for && !invoice.is_credited">
						<button
							@click="setAsPaid()"
	...
	export default {
		...
		methods: {
			...
			getItemTotal(item) {
				...
				const total =
					item.net_amount + item.net_amount * (item.vat_rate / 100);
